        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-lg text-gray-700 leading-relaxed text-justify">
            <p>
              ...
              transforms international commerce into an efficient, transparent,
              and structured experience for professional buyers and verified
              manufacturers.{" "}
              <a
            ...
            <p>
              ...
              business model into a production-ready digital platform that could
              launch, gain initial traction, and establish LeanZupply as a
              trusted name in D2B supply chain procurement.
            </p>
            <p>
              ...
              that would allow the founder to launch, acquire initial users, and
              establish the platform's reputation—all while maintaining the
              quality and reliability needed for professional D2B transactions.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-lg text-gray-700 leading-relaxed text-justify">
            ...
            <ul className="space-y-4 text-lg text-gray-700 leading-relaxed list-disc list-inside ml-4">
              ...
              <li>
                Support initial user acquisition and traction without technical
                limitations blocking growth
              </li>
              <li>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg text-gray-700 leading-relaxed text-justify">
                ...
                built for launch, who it served, and what success looked like in
                the first 90 days. This involved defining core user types and
                roles (buyer, manufacturer, and superadmin), implementing
            ...
            <div>
              ...
              <p className="text-lg text-gray-700 leading-relaxed text-justify">
                We built the complete digital marketplace—frontend, backend, and
                core features needed for launch. Every system was
            ...
            <div>
              ...
              <p className="text-lg text-gray-700 leading-relaxed text-justify">
                ...
                codebase. This ensured code quality, reliable deployments, and a
                foundation that the founder's team could maintain and extend
                with confidence.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-lg text-gray-700 leading-relaxed text-justify">
                We implemented security measures, error handling, and monitoring
                systems essential for a D2B platform. The founder needed
                confidence that the platform could handle commercial
          ...
          <div className="space-y-6">
            <ul className="space-y-4 text-lg text-gray-700 leading-relaxed">
              <li className="flex items-start gap-3">
                ...
                <span>
                  Launched production-ready MVP in 90 days, enabling the founder
                  to go to market and start acquiring users immediately
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-gray-900 font-semibold mt-1">•</span>
                <span>
                  Platform successfully handled initial user acquisition and [X]
                  transactions without technical issues blocking growth
                </span>
              </li>
              <li className="flex items-start gap-3">
                <span className="text-gray-900 font-semibold mt-1">•</span>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-lg text-gray-700 leading-relaxed text-justify">
            <p>
              ...
              products that scale. No junior developers learning on the client's
              time.
            </p>
            <p>
              <strong className="text-gray-900">Disciplined scope.</strong> We
              focused on what was needed to launch and gain initial traction,
              not what was nice to have. This kept the 90-day timeline realistic
              and the MVP production-ready.
            </p>
            <p>
            ...
            <p>
              ...
              Complete documentation, clear architecture, and knowledge transfer
              meant the LeanZupply team could own and extend the system
              independently. We also supported future hiring efforts, helping
              identify engineers who could maintain the quality standards we
              established. No vendor lock-in, but continued partnership where it
              mattered.
            </p>
            <p>
              The difference wasn't in the tools or technologies we used—it was
              in the quality of decisions, the focus on what actually matters,
              and the commitment to building systems that last.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white border-l-4 border-gray-900 pl-8 py-8">
            <blockquote className="text-xl text-gray-700 leading-relaxed italic mb-4">
              "[Founder quote about Urruty Labs' impact on launching the digital
              platform, the 90-day timeline, and how the production-ready MVP
              enabled initial traction and established LeanZupply's name in the
              market.]"
            </blockquote>
      ...
      <section className="py-24 px-6 bg-gray-900 text-white">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl md:text-4xl font-bold mb-6">
            If you're building something new — or your current platform needs a
            real foundation — let's talk.
          </h2>
          <a
