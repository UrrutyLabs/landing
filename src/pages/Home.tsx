...
function Home() {
  return (
    <>
      <Helmet>
        <title>Build Production-Ready Products in 90 Days | Urruty Labs</title>
        <meta
          name="description"
          content="AI-Augmented, Human-Led engineering for early-stage startups. Senior engineers build production-ready MVPs in 90 days. Founder-to-founder partnership."
        />
        <meta
          property="og:title"
          content="Build Production-Ready Products in 90 Days | Urruty Labs"
        />
        <meta
      ...
      <main>
        <section className="pt-32 pb-20 px-6">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 leading-relaxed mb-10 max-w-3xl mx-auto text-justify">
              A boutique engineering partner helping founders turn validated
              ideas into production-ready products — fast, focused, and
              senior-led.{" "}
              <Link
                to="/about"
              ...
              <div className="bg-red-50 border-2 border-red-200 rounded-xl p-8">
                ...
                <ul className="space-y-4 text-gray-700">
                  ...
                  <li className="flex items-start gap-3">
                    <span className="text-red-600 mt-1">•</span>
                    <span>
                      You want open-ended scope and ongoing maintenance
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
                    <span className="text-red-600 mt-1">•</span>
                    <span>
                      You're seeking a feature factory without strategic
                      direction
                    </span>
                  </li>
                  <li className="flex items-start gap-3">
        ...
        <section className="py-20 px-6 bg-gray-50">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 text-center">
              Production-Ready Foundations in 90 Days
            </h2>
              ...
              <div className="bg-white rounded-lg p-6 border border-gray-200 hover:border-gray-300 transition-all">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 text-justify">
                      We execute with production quality from day one. Clean
                      code, tested, documented, and ready to scale.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg p-6 border border-gray-200 hover:border-gray-300 transition-all">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 text-justify">
                      Security, performance, monitoring, and production
                      readiness. We launch with confidence, not crossed fingers.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="py-20 px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 text-center">
              AI-Augmented, Human-Led Engineering
            </h2>
            <p className="text-2xl md:text-3xl font-semibold text-gray-900 mb-8 text-center">
              Senior Engineering Judgment with AI Acceleration
            </p>
            <div className="space-y-6 text-lg text-gray-700 leading-relaxed text-justify">
              <p>
                AI has transformed how software gets built. Tasks that once
                required teams of engineers — boilerplate code, refactors,
                tests, documentation, architecture exploration — can now be
                automated or accelerated by AI-powered agents.
              </p>
              <p>
                At Urruty Labs, we use AI to compress months of engineering
                effort into weeks, while keeping all product decisions in the
                hands of an experienced lead engineer.
              </p>
              <div className="mt-8">
              ...
              <p>
                Every architectural decision, every tradeoff, every critical
                line of code is reviewed and owned by a senior engineer. AI
                accelerates the work — experience ensures it's done right.
              </p>
        ...
        <section className="py-20 px-6 bg-gray-50">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-12 text-center">
              Senior Engineering Partner for Early-Stage Startups
            </h2>
            <p className="text-lg text-gray-600 text-center mb-12 max-w-2xl mx-auto">
              See how we've helped founders build production-ready products.{" "}
              <Link
                to="/case-studies"
                className="text-gray-900 underline hover:text-gray-600 transition-colors"
              >
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-white rounded-lg p-8 border border-gray-200">
                ...
                <p className="text-gray-700">
                  No junior developers figuring it out on your dime. Decisions
                  are made by people who've been here before.
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg p-8 border border-gray-200">
                ...
                <p className="text-gray-700">
                  We build so you can continue. No vendor lock-in, no
                  proprietary frameworks, no ongoing retainer required.
                </p>
              </div>
              ...
              <div className="bg-white rounded-lg p-8 border border-gray-200">
                ...
                <p className="text-gray-700">
                  90 days. Defined deliverables. Predictable investment. You
