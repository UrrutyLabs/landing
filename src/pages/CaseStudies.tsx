...
function CaseStudies() {
  return (
    <>
      <Helmet>
        <title>
          Case Studies — Senior-Led Engineering for Startups | Urruty Labs
        </title>
        <meta
          name="description"
          content="Real examples of senior technical leadership, production-ready MVPs, and 90-day product builds for early-stage startups. See how we help founders scale."
        />
        <meta
          property="og:title"
          content="Case Studies — Senior-Led Engineering for Startups | Urruty Labs"
        />
        <meta
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white rounded-lg border border-gray-200 p-8 hover:border-gray-300 transition-all">
                ...
                <p className="text-gray-700 leading-relaxed mb-6">
                  ...
                  marketplace, establishing architecture that scales, and
                  enabling initial traction in a complex D2B supply chain
                  environment. Technical foundations built for scaling, with
                  senior engineering judgment throughout.
                </p>
                <Link
        ...
        <section className="py-24 px-6 bg-gray-900 text-white">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              If you're working on something new — or your current product needs
              a stronger foundation — let's talk.
            </h2>
            <a
